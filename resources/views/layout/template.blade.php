...
<body>
	...
	<div class="header-info">
		<div class="container">
			<div class="header-top-in">
				...
				<ul class="support">
					<li><a href="https://wa.me/+6285762341180"><i class="fab fa-whatsapp-square"></i>Whatsapp</a></li>
				</ul>
		...
		<div class="header-top">
			...
			<div class="header-bottom">
				<div class="container">
					...
					<h1 style="color: #0c1123;">Lapangan Badminton</h1>
	...
	<div class="footer">
		<div class="container">
			...
			<div class="clearfix"> </div>
			<p class="footer-class">Copyrights © 2024 Deny Sinurat. All rights reserved</p>
		</div>
	</div>
	<!---->
